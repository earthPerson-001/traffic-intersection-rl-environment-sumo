...
env = gym.make("TrafficIntersectionEnv{}LaneGUI-v1".format(TRAFFIC_INTERSECTION_TYPE.capitalize()), sumocfg_file=sumocfg_file, network_file=net_file, route_file=route_file, use_gui=False, total_timesteps=TOTAL_TIMESTEPS_FOR_SUMO, min_green=30, yellow_time=10)
...
model = PPO.load("/home/bishal/Programming/reinforcement-learning-env-gui/models/2022-08-26 20:31:22.136701-TrafficIntersection-{}LaneGUI-ppo-300000".format(TRAFFIC_INTERSECTION_TYPE.capitalize(), modelType), env=env)
