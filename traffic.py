...
import gym
from custom_gym.envs.custom_env_dir import TrafficIntersectionEnvSingleLaneGUI
...
route_file=SUMO_DIRECTORY + "/small-map-double-lane.rou.xml"
...
model = PPO.load("/home/bishal/Programming/reinforcement-learning-env-gui/models/2022-08-19 16:31:36.013366-TrafficIntersection-{}LaneGUI-ppo-145000000".format(TRAFFIC_INTERSECTION_TYPE.capitalize()))
